...
public class DeptDTO {
    ...
    private String deptWorknumberName;
    ...
    public String getDeptWorknumberName() {
        return deptWorknumberName;
    }

    public void setDeptWorknumberName(String deptWorknumberName) {
        this.deptWorknumberName = deptWorknumberName;
    }
