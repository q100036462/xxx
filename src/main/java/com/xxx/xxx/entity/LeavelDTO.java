...
public class LeavelDTO {
    ...
    private String leaveWorknumberName;
    ...
    public String getLeaveWorknumberName() {
        return leaveWorknumberName;
    }

    public void setLeaveWorknumberName(String leaveWorknumberName) {
        this.leaveWorknumberName = leaveWorknumberName;
    }
}